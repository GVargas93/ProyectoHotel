<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListaGeneral.aspx.cs" Inherits="WebServicesReservas.ListaGeneral" %>
            ...
            <div class="center">
               <h2>Portfolio</h2>
                <p>
                    ...
                    <asp:Button ID="Button1" runat="server" CssClass="btn-default" Text="Buscar" OnClick="Button1_Click" />
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Cancelar" />
                </p>
                <asp:GridView ID="GridViewListaGeneral" runat="server" class="table table-striped" AutoGenerateColumns="False" CssClass="table table-striped">
                    <Columns>
                        ...
                        <asp:BoundField DataField="TipoHabitacion" HeaderText="Tipo Habitacion" />
                    </Columns>
                </asp:GridView>
