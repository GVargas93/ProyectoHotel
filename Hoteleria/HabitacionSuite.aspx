<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestraCliente.master" AutoEventWireup="true" CodeFile="HabitacionSuite.aspx.cs" Inherits="HabitacionSuite" %>
          ...
          <!-- <ol class="carousel-indicators">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <img src="img/hSuite1.jpg" alt="New York" height="1200" >
                ...
                <div class="item">
                  <img src="img/hSuite2.jpg" alt="Chicago" height="1200"  >
                  <div class="carousel-caption">
                ...
                <div class="item">
                  <img src="img/hSuite3.jpg" alt="Chicago" height="1200"  >
                  <div class="carousel-caption">
                ...
                <div class="item">
                    <img src="img/hSuite4.jpg" alt="Los Angeles" height="1200"  >
                    <div class="carousel-caption">
                          ...
                          <div class="row">
                              <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12  ">
                                  <div class="form-group">
                                      <label></label>
                                      <h1><i class="fa fa-user" aria-hidden="true"></i>2   <i class="fa fa-bed" aria-hidden="true"></i> </h1>
                                      <label></label>
                                  </div>
                              </div>
